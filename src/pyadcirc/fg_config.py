FG_config = [
  ...
  {'index':7,'name':'label','desc':'Alphanumeric label for these plots.',
    'type':str, 'default':None},
  {'index':8,'name':'title','desc':'Plot label flag and plot label.',
    'type':str, 'default':None, 'flag_var':True},
  ...
  {'index':51,'name':'coastline',
      ...
      'type':tuple, 'default':(51,0,'White',4,4)},
  {'index':52,'name':'hurrican_track',
